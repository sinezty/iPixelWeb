#!/usr/bin/env python3
"""
iPixel LED Matrix Display Demo - 64x16
======================================
...
def render_glm(data):
    ...
    draw_text_gradient(d, "GLM", 0, 1, (0, 200, 100), (0, 255, 200))
    draw_text_gradient(d, time_str, WIDTH - text_width(time_str), 1, (255, 80, 0), (255, 180, 0))
    draw_bar(d, 0, 8, WIDTH - 2, percent, (0, 130, 30), (0, 255, 100))
...
def render_codex(data):
    ...
    bar_w = (WIDTH - 6) // 2
    draw_bar(d, 0, 8, bar_w, p5, (120, 0, 120), (255, 0, 150), show_percent=False)
    draw_bar(d, bar_w + 4, 8, bar_w, pw, (150, 30, 0), (255, 110, 0), show_percent=False)
...
def render_gpt(data):
    ...
    draw_text_gradient(d, time_str, WIDTH - text_width(time_str), 1, (255, 80, 0), (255, 180, 0))
    draw_bar(d, 0, 8, WIDTH - 2, percent, (0, 80, 180), (0, 210, 255))
...
def render_weather(data):
    ...
    temp_text = f"{temp}C"
    draw_text_gradient(d, temp_text, 0, 1, (255, 140, 0), (255, 200, 0))
...
def render_gemini(data):
    ...
    draw_text_gradient(d, time_str, WIDTH - text_width(time_str), 1, (255, 80, 0), (255, 180, 0))
    draw_bar(d, 0, 8, WIDTH - 2, percent, (58, 13, 189), (0, 180, 255))
...
def render_claude(data):
    ...
    draw_text_gradient(d, time_str, WIDTH - text_width(time_str), 1, (255, 80, 0), (255, 180, 0))
    draw_bar(d, 0, 8, WIDTH - 2, percent, (179, 57, 37), (233, 154, 119))
...
def get_data(page):
    ...
    if page == "glm":
        return {"percent": random.randint(10, 95)}
    elif page == "codex":
        return {"p5": random.randint(10, 90), "pw": random.randint(20, 95)}
    elif page == "gpt":
        return {"percent": random.randint(15, 85)}
    elif page == "weather":
        descs = ["GUNESLI", "BULUTLU", "PARCALI", "YAGMURLU", "SISLI"]
        return {"temp": random.randint(10, 35), "hum": random.randint(30, 90), "desc": random.choice(descs)}
    elif page == "gemini":
        return {"percent": random.randint(5, 98)}
    elif page == "claude":
        return {"percent": random.randint(10, 90)}

def main():
    parser = argparse.ArgumentParser(description="iPixel LED Matrix Demo - 64x16")
